...
public class AddProductWIthPLUCodeGUI extends CustomerView {
	...
	public AddProductWIthPLUCodeGUI(CustomerUI customer) {
		...
		button_Enter.addActionListener(e -> {
			...
			// verify PLU  is correct
			// if yes, then add to shopping cart
			// if not, call attendant
			...
			CustomerUISimulator.currentCustomer.selectNextItem();
			CustomerUISimulator.currentCustomer.placeItemInBaggingArea();
